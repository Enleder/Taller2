...
public class TestFachadaLogica {
	...
	public static void main(String[] args)
		...
		do {
			...
			System.out.println("5) Cierre de performances y definiciï¿½n de finalistas");
			System.out.println("6) Ingreso de performance de un participante");
			System.out.println("7) Cierre de votaciï¿½n del pï¿½blico");
			// System.out.println("8) Respaldo de datos");
			System.out.println("9) Listado de finalistas y ganador del certamen");
			System.out.println("10) Votaciï¿½n de un ganador");
			...
			case "5":
				if (QuedaAlgunaPerformance) {
					...
					if (EstadoVotacion || HayGanador) {
						...
						System.out.println("Entro a la opcion: 5) Cierre de performances y definiciï¿½n de finalistas");
						try {
			...
			case "7":
				if (!EstadoVotacion) {
					...
					System.out.println("Entro a la opcion: 7) Cierre de votación del pï¿½blico");
					try {
						fachada.R7CierreVotacionPublico();
						System.out.println("Se cerro la votacón del pï¿½blico correctamente");
			...
			case "10":
				if (!EstadoVotacion) {
					...
					System.out.println("Entro a la opcion: 10) Votaciï¿½n de un ganador");
					System.out.println(
						...
						while (iter.hasNext()) {
							...
							try {
								...
								if (voDetallado.getTipoDeParticipante() == TipoParticipante.NACIONAL) {
									...
									System.out.println(" Aï¿½os en el Paï¿½s  : "
